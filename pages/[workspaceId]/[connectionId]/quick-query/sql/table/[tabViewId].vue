...
import type { TableDetailMetadata } from '~/core/types/entities/tab-view.entity';
...
const { metadata, tabInfo, workspaceId } =
  useTabViewPage<TableDetailMetadata>();
</script>
...
<template>
  <QuickQuery
    ...
    :tab-view-type="TabViewType.TableDetail"
  />
