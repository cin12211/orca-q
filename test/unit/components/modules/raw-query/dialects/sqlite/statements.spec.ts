...
describe('SQLite Statement Parsing', () => {
  const parserDialect = SQLDialectSupport.SQLite;
...
SELECT 2;!
  ...
  describe('Double Quote Identifiers', () => {
    it('should ignore semicolons inside double-quoted identifiers (SQLite standard)', () => {
