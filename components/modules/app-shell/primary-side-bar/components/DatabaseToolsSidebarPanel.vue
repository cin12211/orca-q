...
import {
  MongoDatabaseToolsPanel,
  RedisDatabaseToolsPanel,
  SqlDatabaseToolsPanel,
} from '#components';
...
const current = computed<Component | null>(() => {
  switch (props.dbType) {
    case DatabaseClientType.MONGODB:
      return MongoDatabaseToolsPanel;
    case DatabaseClientType.REDIS:
      return RedisDatabaseToolsPanel;
