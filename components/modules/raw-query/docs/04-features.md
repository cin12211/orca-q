...
## 6. MongoDB Raw Query (Beta)

- MongoDB collection actions create extensionless query files and open them in
  TypeScript mode with collection, field, BSON, cursor, and operator
  suggestions.
